...
<head>
    <title>EGP | Cadastro local</title>
    <meta charset="UTF-8">
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="login-container">
                    <h2 class="text-center">Anúbis - Engenharias | Cadastro de local</h2>
                    <form method="post" action="/trabalho-dsw-ads6/models/CadastrolocalModel.php" accept-charset="UTF-8">
                        <div class="form-group">
                            <label for="departamento_id">Departamento:</label>
                            <select class="form-control" id="departamento_id" name="departamento_id" required>
                                <?php
                                $sql = "SELECT id, departamento FROM ANUBIS_departamentos";
                        ...
                        <button type="submit" class="btn btn-primary btn-block"
                            ...
                            style="font-size: 20px; padding: 15px 30px;">Cadastrar local</button>
                    </form>
                    <hr>
                </div>
